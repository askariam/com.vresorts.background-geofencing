...
//	private LocationManager locationManager;
    ...
    private Intent updateGeotrackerIntent;
	
	private Context context;
	
	static final String GEOTRIGGER_ACTION  = "com.vresorts.cordova.bgloc.STATIONARY_REGION_ACTION_TRIGGERED";
	static final String GEOTRIGGER_CATEGORY = "com.vresorts.cordova.bgloc.STATIONARY_REGION";
	
	
	static final String GEOTRIGGER_DATA_HOST = "bgloc.cordova.vresorts.com";
	static final String GEOTRIGGER_DATA_SCHEME = "geotrigger";
...
//	    this.locationManager = (LocationManager) this.context.getSystemService(Context.LOCATION_SERVICE);
		updateGeotrackerIntent = new Intent(this.context, Geotracker.class);
...
//				}
	...
	private void stopGeotracker(){
		this.context.stopService(updateGeotrackerIntent);
	}
	
	private void udpateGeotracker(){
		this.updateGeotrackerIntent.putExtra(Geotracker.GEOTRACKER_FIELD_COMMAND, Geotracker.GEOTRACKER_COMMOND_CONFIGURE_TRIPPLAN);
		this.updateGeotrackerIntent.putExtra(Geotracker.GEOTRACKER_FIELD_DATA_TRIPPLAN, this.tripplan.toJSONObject().toString());
		this.context.startService(updateGeotrackerIntent);
	}
